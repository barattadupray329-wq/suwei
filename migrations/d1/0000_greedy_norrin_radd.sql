...
--> statement-breakpoint
CREATE UNIQUE INDEX `account_profiles_userId_unique` ON `account_profiles` (`userId`);--> statement-breakpoint
CREATE UNIQUE INDEX `account_profiles_phone_unique` ON `account_profiles` (`phone`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `business_settings_userId_unique` ON `business_settings` (`userId`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `contract_snapshots_rentalId_unique` ON `contract_snapshots` (`rentalId`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `customer_phone_sessions_token_hash_unique` ON `customer_phone_sessions` (`token_hash`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `customer_portals_accessTokenHash_unique` ON `customer_portals` (`accessTokenHash`);--> statement-breakpoint
CREATE UNIQUE INDEX `customer_portals_userId_phone_unique` ON `customer_portals` (`userId`,`phone`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `organization_members_memberUserId_unique` ON `organization_members` (`memberUserId`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `receivable_bills_userId_billNo_unique` ON `receivable_bills` (`userId`,`billNo`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `rentals_userId_contractNo_unique` ON `rentals` (`userId`,`contractNo`);--> statement-breakpoint
