...
五、租金与押金
6. 承租方应按合同约定的金额与周期按时支付租金；押金在租期结束、设备验收无误并结清全部费用后无息退还，出租方可从押金中扣除承租方应付未付的租金、维修费及赔偿款。
7. 承租方逾期支付租金的，出租方有权按约定收取逾期违约金；经催告后在合理期限内仍不支付的，出租方有权依法解除合同、提前收回设备，并要求承租方赔偿由此造成的损失。

六、租期、续租与退租
8. 租期届满需继续租用的，承租方应提前办理续租手续；退租时应将设备及全部配件完好归还，并配合出租方验收，验收产生的损坏或缺失费用由责任方承担。

七、法律适用与争议解决
9. 本合同的订立、效力、解释、履行及争议解决均适用中华人民共和国法律。
10. 本合同在履行过程中发生争议的，双方应友好协商解决；协商不成的，任何一方均可向合同签订地（福建省龙岩市）有管辖权的人民法院提起诉讼。
11. 本合同未尽事宜，双方可另行签订补充协议，补充协议与本合同具有同等法律效力；本合同一式两份，出租方与承租方各执一份，自双方签字（盖章）之日起生效，具有同等法律效力。`
