...
type Row = { id: number; orderType: string; lifecycleStatus: string; deletedAt: Date | null; contractNo: string; customerCompany: string | null; customerName: string; customerPhone: string; deviceName: string; quantity: number; startDate: string; endDate: string; periodCount: number; paidPeriodCount: number; unpaidPeriodCount: number; partialPeriodCount: number; billingUnit: string; totalRent: string; paidAmount: string; paymentStatus: string; status: string; assigneeName: string | null }
