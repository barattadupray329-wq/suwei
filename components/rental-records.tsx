...
export function RentalRecords({ rows, total, page, pageCount, filters, assignees, access }: { rows: Row[]; total: number; page: number; pageCount: number; filters: Filters; assignees: Assignee[]; access: Access }) {
